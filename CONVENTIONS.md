...
| PRs that change the official skill count without updating generated counts | Run `python3 scripts/count-repository-items.py` and explain the delta |
...
| Skill count | Generated by `python3 scripts/count-repository-items.py` |
