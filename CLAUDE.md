...
- Top-level skill folders per domain: Engineering Core (36), Engineering POWERFUL (46), Product (16), Marketing (44), PM (8), C-Level (28), RA/QM (13), Business & Growth (4), Finance (3) = 198 top-level. The 239 total additionally counts nested sub-skills (~32) and the 9 per-domain bundles.
