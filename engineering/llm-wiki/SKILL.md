...
- `references/production-deployment-patterns.md` — scaling the wiki into a maintained typed graph (entity/relation extraction, anti-noise rules, health/lint/digest, telemetry quarantine)
