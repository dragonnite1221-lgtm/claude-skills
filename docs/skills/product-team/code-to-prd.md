...
description: "Reverse-engineer a frontend, backend, or fullstack codebase into a complete Product Requirements Document. Scans routes/pages, components, state, API. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
1. **Identify the framework** from `package.json` (Node), `manage.py` (Django), or
   ...
   framework — see [framework-patterns.md](https://github.com/alirezarezvani/claude-skills/tree/main/product-team/code-to-prd/references/framework-patterns.md) for the directory
...
Validate the result against [prd-quality-checklist.md](https://github.com/alirezarezvani/claude-skills/tree/main/product-team/code-to-prd/references/prd-quality-checklist.md).
...
| File | Contents |
|------|----------|
| [framework-patterns.md](https://github.com/alirezarezvani/claude-skills/tree/main/product-team/code-to-prd/references/framework-patterns.md) | Per-framework routes, state, APIs, forms, permissions, mock-detection signals |
| [prd-quality-checklist.md](https://github.com/alirezarezvani/claude-skills/tree/main/product-team/code-to-prd/references/prd-quality-checklist.md) | Validation checklist for completeness, accuracy, readability |
