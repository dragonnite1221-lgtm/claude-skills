...
description: "Detect a monorepo's tool (Turborepo, Nx, pnpm/yarn workspaces, Lerna), enumerate its workspaces, and build the internal package dependency graph from. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
- [references/monorepo-tooling-reference.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/monorepo-navigator/references/monorepo-tooling-reference.md) — Turborepo/Nx/pnpm/Changesets details
- [references/monorepo-patterns.md](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/monorepo-navigator/references/monorepo-patterns.md) — architecture and CI patterns
