...
description: "Generate production-ready Playwright tests from a user story, URL, component path, or feature description ($ARGUMENTS). Explores the project for. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
